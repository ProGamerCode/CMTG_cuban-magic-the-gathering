...
TEST_CASE("Tree Traversal") {
	void testTreeTraversals() {
		...
		XMLTree<std::string, std::string>* rootTree1 = Tools::XMLParser("c:Users/Student/Desktop/Magic/Tools/x64/Debug/data/tree", "test1.xml", messages);
		...
		XMLTree<std::string, std::string>* rootTree2 = Tools::XMLParser("c:Users/Student/Desktop/Magic/Tools/x64/Debug/data/tree", "test2.xml", messages);
		...
		XMLTree<std::string, std::string>* rootTree3 = Tools::XMLParser("c:Users/Student/Desktop/Magic/Tools/x64/Debug/data", "test3.xml", messages);
	...
	void testXMLParser() {
		...
		static const std::string DATA_PATH = "c:Users/Student/Desktop/Magic/Tools/x64/Debug/data/ife";
